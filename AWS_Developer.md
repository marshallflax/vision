...
- CodeBuild (building and testing)
  ...
  - Environment variables
    ...
    | ------------ | ------- |
    | AWS*DEFAULT_REGION | The AWS Region where the build is running (for example, us-east-1). This environment variable is used primarily by the AWS CLI. |
